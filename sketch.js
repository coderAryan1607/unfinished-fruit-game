...
var knife,fruit ,monster,fruitGroup,monsterGroup, score,r,randomFruit, position, ghostSword;
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage;

function preload(){
  
  knifeImage = loadImage("knife.png");
  monsterImage = loadAnimation("ghost2.png","ghost1.png")
  fruit1 = loadImage("fruit1.png");
  fruit2 = loadImage("fruit2.png");
  fruit3 = loadImage("fruit3.png");
  fruit4 = loadImage("fruit4.png");
  gameOverImage = loadImage("gameover.png")
  ghostSword = loadImage("ghostRepel.png");
...
function changeSword(){
  if(keyDown("up")){
    knife.changeImage("ghostDestroy",ghostSword);
}
}